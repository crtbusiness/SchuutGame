...
def yellow_handle_movement(keys_pressed, yellow):
    ...
    if keys_pressed[pygame.K_w] and yellow.y - VEL > 0: #UP player yellow
        yellow.y -= VEL
    if keys_pressed[pygame.K_s] and yellow.y + VEL + yellow.height < WINDOW_HEIGHT - 10: #DOWN player yellow
        yellow.y += VEL
...
def red_handle_movement(keys_pressed, red):
    ...
    if keys_pressed[pygame.K_UP] and red.y - VEL > 0: #UP player red
        red.y -= VEL
    if keys_pressed[pygame.K_DOWN] and red.y + VEL + red.height < WINDOW_HEIGHT - 10: #DOWN player red
        red.y += VEL
